		...
		<div class="content">
			<div class="row underline">
				<div class="col s12 mb5">
					<div class="left">
						Insentif / <a href="<?= base_url();?>insentif-mingguan"> Mingguan</a> / Add 
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col s12 m12 l4">
					<div class="card-panel">
						<div id="form-add" data-href="<?= base_url();?>insentif-mingguan" data-url="<?= base_url();?>insentif/mingguan/insert">
							<div class="row mb-0">
								<div class="input-field col s12">
									<select id="user_id" data-url="<?= base_url();?>insentif/mingguan/get_data_user">
										<option value="" selected="selected" disabled="disabled">Pilih Pegawai</option>
										<?php
							...
							<div class="row mb-0">
								<div class="input-field col s12 m7">
									<input type="text" id="input-insentif" class="text-jumlah" readonly="true" />
									<input type="hidden" id="insentif" />
									<label for="input-insentif" id="label-insentif">Insentif</label>
								</div>
