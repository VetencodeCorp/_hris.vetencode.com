...
<html lang="en">
	...
	<body>
			...
			<div class="row">
				<div class="col s12">
					<div class="card-panel">
						<form id="wrap-search" data-url="<?= base_url();?>report/mingguan/search_data" class="row">
		...
		<script type="text/javascript" src="<?= base_url();?>assets/js/modules/report_mingguan.js"></script>
	</body>
</html>
